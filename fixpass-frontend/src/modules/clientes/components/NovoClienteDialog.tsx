  ...
  async function handleNext() {
    ...
    if (isLastStep) {
      ...
      await createClient.mutateAsync({
        personType,
        name: personType === 'PF' ? (values as ClientPFFormValues).nomeCompleto : (values as ClientPJFormValues).razaoSocial,
        email: values.email || undefined,
        phone: values.telefone || undefined,
        city: values.cidade || undefined,
        state: values.estado || undefined,
        document: personType === 'PF' ? (values as ClientPFFormValues).cpf : (values as ClientPJFormValues).cnpj,
        categoryIds: [],
      })
      resetAndClose()
      return
