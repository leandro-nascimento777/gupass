/**
 * Tipos das entidades de negócio do FixPass (ver DOCUMENTACAO_TCC_FIXPASS.md, seção 16).
 * Estes tipos espelham o contrato que o backend real (Nest, feito à parte) deverá
 * implementar — ver API_CONTRACT.md. Nenhuma regra de negócio vive aqui, só formato de dado.
 */
