 ...
 * recibos, bilhetes"). Os recursos em si (Sale, Quote, Contract, Receipt,
...
import type { Contract, Paginated, Quote, Receipt, Sale, Ticket } from '@/types/entities'
...
export const clientHistoryAdapter = {
  ...
  listReceipts(clientId: string) {
    return httpClient.get<Paginated<Receipt>>('/receipts', { clientId, pageSize: HISTORY_PAGE_SIZE })
  },
