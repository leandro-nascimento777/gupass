...
/**
 * Placeholder para módulos ainda não construídos (ver docs/MAPEAMENTO_TELAS.md,
    ...
    <div className="flex flex-col gap-4">
      ...
      <Card>
        ...
        <CardContent className="text-center text-sm text-muted-foreground">
          Esta tela ainda não foi implementada nesta sprint. Ver docs/MAPEAMENTO_TELAS.md para a ordem de prioridade.
        </CardContent>
      </Card>
    </div>
  )
